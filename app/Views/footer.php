        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                        ...
                        <div class="row">
                            <form id="contact" action="" method="post">
                                <div class="row">
                                    <div class="col-md-12">
                                        <fieldset>
                                            <input name="firstname" type="text" class="form-control" id="firstname" placeholder="Your name..." required="">
                                        </fieldset>
                                    </div>
                                    <div class="col-md-12">
                                        <fieldset>
                                            <input name="phone" type="text" class="form-control" id="phone" placeholder="XXX-XXX-XX-XX" required="">
                                        </fieldset>
                                    </div>
                                    <div class="col-md-12">
                                        <fieldset>
                                    ...
                                    <div class="col-md-12">
                                        <fieldset>
                                            <button type="submit" id="form-submit" class="btn btn-primary">Перезвоните мне</button>
                                        </fieldset>
                    ...
                    <div class="contact-form-success text-black">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="footer-contact">
                                    <h3>Контакты</h3>
                                    <p><i class="fa fa-map-marker-alt"></i>Местонахождение яхты: яхт-клуб Ривьера, Днепровская набережная, 10.</p>
                                    <p><i class="fa fa-phone-alt"></i>+3809756797</p>
